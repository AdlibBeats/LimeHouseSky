...
namespace LimeHouseSky
{
    public class AnimatedGradientBrush : XamlCompositionBrushBase
    {
        ...
        private static readonly Color GradientStop1StartColor = Color.FromArgb(127, 125, 80, 90);
        private static readonly Color GradientStop2StartColor = Color.FromArgb(0, 0, 0, 0);
        ...
        protected override void OnConnected()
        {
            ...
            void StartGradientColorAnimations()
            {
                ...
                color1Animation.InsertKeyFrame(0.5f, Color.FromArgb(127, 0, 0, 0), linearEase);
                color1Animation.InsertKeyFrame(1.0f, Color.FromArgb(127, 0, 0, 0), linearEase);
                ...
                color1Animation.InsertKeyFrame(0.5f, Color.FromArgb(127, 80, 30, 40), linearEase);
                color2Animation.InsertKeyFrame(1.0f, Color.FromArgb(127, 40, 10, 15), linearEase);
